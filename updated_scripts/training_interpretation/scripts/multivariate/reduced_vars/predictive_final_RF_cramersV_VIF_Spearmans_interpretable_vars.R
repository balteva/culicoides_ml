...
############################################################"
############################################################"
vars_presence_numerical <- c( #prediction only
"TM_0_0", 
"TN_0_0",
"TX_0_4", 
"UM_0_0", 
...
filter(!is.na(OVI), !is.na(BETAIL), !is.na(ALT), !is.na(NDVI_0_0), !is.na(NDVI_0_0))
...
##pearsons selected vars for prediction : "TX_0_4"   "SWV_0_4"  "NDVI_0_0" "ALT"      "OVI"      "BETAIL" (11/04/2025)
...
write.csv(df_model, "./updated_scripts/predictive_df_model_for_RF.csv", row.names = F)
...
numeric_abundance_vars <- c("TM_0_0", #average temperature
                            "TN_0_0",#min temp
                            "TX_0_0", #max temp
                            "UM_0_0", #relative humiditty #will probably remove relative humidity
...
df_model_numerical <- df_model %>%
  filter(!is.na(ALT), !is.na(EVI_0_6), !is.na(FG_0_3), !is.na(NDVI_0_5))
...
#pearsons 11/04/2025 ; "UM_0_0"   "QQ_0_5"   "SWV_0_0"  "FG_0_3"   "NDVI_0_5" "ALT" 
#vif      11/04/2025 ;  "UM_0_0"   "PP_1_5"   "SWV_0_0"  "FG_0_3"   "NDVI_0_5" "ALT" <- using this one
...
filtered_numer_abundance_vars <- c("UM_0_0",   "PP_1_5",   "SWV_0_0",  "FG_0_3" ,  "NDVI_0_5", "ALT")
predictors_abundance <- filtered_numer_abundance_vars
...
df_model_abundance <- df_model %>%
  ...
  mutate(across(ID_SITE:year, as.factor))%>%
  filter(!is.na(NDVI_0_5), !is.na(FG_0_3))
...
saveRDS(res_multiv_model_abundance_LLO, "./updated_scripts/models/predictive_abundance_LLO.rds")
...
saveRDS(res_multiv_model_abundance_LTO, "./updated_scripts/models/predictive_abundance_LTO.rds")
