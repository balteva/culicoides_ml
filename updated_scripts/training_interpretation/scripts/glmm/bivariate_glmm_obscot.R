...
write.csv(glmm_univ_presence,'./updated_scripts/data/glmm//predictive_glmm_presence_obscot.csv', row.names = F)
...
write.csv(glmm_univ_abundance,'./updated_scripts/data/glmm/predictive_glmm_abundance_obscot.csv', row.names = F)


write.csv(df_model, '../../updated_scripts/data/df_landscape_for_multivariate.csv', row.names = F)