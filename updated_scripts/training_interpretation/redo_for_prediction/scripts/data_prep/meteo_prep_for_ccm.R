...
pieges_data <- read.csv("./data/obscot_femelles_pares_indiv_df.csv") %>%
...
write.csv(df_to_model,file.path("./data","df_to_model_obscot_femelles_pares_indiv.csv"), row.names = F)
