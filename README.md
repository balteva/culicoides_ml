...
![binary presence LTO output](./culicoides_ml/updated_scripts/interpretation/model/presence/binary_LTO.jpeg)

        With Ecolimatic zones
 C. obsoletus/scoticus predicted vs observed presence 2009-2012 with Leave-Time-Out (LTO) Cross Validation
![binary presence LTO with ecoclimatic zones](./culicoides_ml/updated_scripts/interpretation/model/presence/eco_cli_year/binary_LTO_ecocli.jpeg)

-----------------------------------
         C. obsoletus/scoticus predicted presence probability 2009-2012 with LTO CV
![presence probability LTO](./culicoides_ml/updated_scripts/interpretation/model/presence/presence_LTO_probability.jpeg)

        Comparing Leave-Location-Out and Leave-Time-Out CV predictions
![presence probabilitY LTO vs LLO](./culicoides_ml/updated_scripts/interpretation/model/presence/LTTO_probability.jpeg)
-----------------------------------
